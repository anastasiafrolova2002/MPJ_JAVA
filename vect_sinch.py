    ...
    public static void main(String[] args) {
        ...
        if (rank == 0) {
            for (int i = 1; i < size; i++) {
                MPI.COMM_WORLD.Ssend(A, i * localN, localN, MPI.INT, i, 0);
                MPI.COMM_WORLD.Ssend(B, i * localN, localN, MPI.INT, i, 1);
            }
        ...
        if (rank == 0) {
            ...
            MPI.COMM_WORLD.Ssend(new int[]{localResult}, 0, 1, MPI.INT, 0, 2);
        }
